...
Дякуємо, що користуєтеся **The Projectfile Specification**!
...
- [Задачі на GitHub](https://github.com/projectfile-org/specification/issues)
...
4. **Середовище** — операційна система, версія The Projectfile Specification, версія середовища виконання.
...
Платна підтримка для The Projectfile Specification доступна:
